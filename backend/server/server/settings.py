...
# Load environment variables from backend/server/.env (local, not committed)
...
SECRET_KEY = 'django-insecure-4xiijlw_@#i8v)muf(c7q+l9ub3+hx^f@f1a!l2zqkf+$1eku$'
...
# Default to PostgreSQL for development; can be overridden by environment variables
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "csvupload"),
